...
SECRET_KEY = os.environ.get(
    "SECRET_KEY", "django-insecure-dg5uywwiqf_xth*97w$oib=49no=2&onr1k23=2)xc+&*%1qjf"
)
...
if DEBUG:
    try:
        import_module("debug_toolbar")  # 导入用于检查模块是否可用
        ...
        DEBUG_TOOLBAR_CONFIG = {
            ...
            "DISABLE_PANELS": {
                ...
                "debug_toolbar.panels.profiling.ProfilingPanel",  # 禁用 Profiling Panel，避免与 Python 3.13 冲突
            },
        }
    except ImportError:
