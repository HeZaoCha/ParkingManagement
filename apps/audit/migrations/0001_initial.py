        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "model_name",
                    models.CharField(
                        help_text="被操作的模型名称", max_length=100, verbose_name="模型名称"
                    ),
                ),
                (
                    "object_id",
                ...
                (
                    "description",
                    models.TextField(
                        blank=True, help_text="操作的详细描述", verbose_name="操作描述"
                    ),
                ),
                (
                    "ip_address",
                    models.GenericIPAddressField(
                        blank=True, help_text="操作来源的IP地址", null=True, verbose_name="IP地址"
                    ),
                ),
                (
                    "user_agent",
            ...
            options={
                ...
                "indexes": [
                    ...
                    models.Index(
                        fields=["model_name", "-created_at"], name="audit_model_created_idx"
                    ),
                ],
            },
        ),
