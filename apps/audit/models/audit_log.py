...
class AuditLog(TimestampMixin, models.Model):
    ...
    model_name = models.CharField(
        max_length=100, verbose_name="模型名称", help_text="被操作的模型名称"
    )
    ...
    description = models.TextField(blank=True, verbose_name="操作描述", help_text="操作的详细描述")
    ip_address = models.GenericIPAddressField(
        null=True, blank=True, verbose_name="IP地址", help_text="操作来源的IP地址"
    )
