...
class ParkingRecordService:
    ...
    def vehicle_entry(
        ...
        try:
            ...
            if parking_space_id:
                # 指定停车位：验证停车位是否可用
                try:
                    parking_space = ParkingSpace.objects.select_for_update(
                        skip_locked=True
                    ).get(
                        pk=parking_space_id,
            ...
            try:
                ...
                if wanted_vehicles.exists():
                    ...
                    for wanted in wanted_vehicles:
                        VehicleAlertLog.objects.create(
                        ...
                        logger.warning(
                            ...
                            normalized_plate, wanted.priority, record.id
                        )
            except (ImportError, AttributeError):
                pass
            ...
            logger.info(
                ...
                normalized_plate, parking_lot.name, parking_space.space_number
            )
    ...
    def vehicle_exit(
        ...
        try:
            ...
            if record_id:
                try:
                    record = ParkingRecord.objects.select_for_update().select_related(
                ...
                record = ParkingRecord.objects.select_for_update().select_related(
                    ...
                    vehicle__license_plate=normalized_plate,
            ...
            logger.info(
                ...
                record.vehicle.license_plate, record.fee, record.duration_minutes
            )
    ...
    def query_vehicle_status(license_plate: str) -> dict[str, Any]:
        ...
        if vehicle:
            ...
            last_record = ParkingRecord.objects.filter(
                ...
                'parking_space', 'parking_space__parking_lot'
    ...
    def create_entry_record(
        ...
        logger.info(
            "车辆 %s 入场，车位: %s",
            vehicle.license_plate, space.space_number
        )
        return record
    ...
    def get_recent_records(limit: int = 10) -> QuerySet[ParkingRecord]:
        ...
        """
        return ParkingRecord.objects.select_related(
            'vehicle',
