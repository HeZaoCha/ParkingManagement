...
urlpatterns = [
    ...
    path(
        "manage/lots/<int:pk>/toggle/",
        admin.parking_lot_toggle_status,
        name="admin_parking_lot_toggle",
    ),
    path(
        "manage/lots/<int:lot_id>/pricing/",
        pricing.parking_lot_pricing_edit,
        name="admin_parking_lot_pricing",
    ),
    path(
        "manage/lots/<int:lot_id>/spaces/create-range/",
        space_creation.space_create_from_range,
        name="admin_space_create_range",
    ),
    path(
        "manage/lots/<int:lot_id>/spaces/create-file/",
        space_creation.space_create_from_file,
        name="admin_space_create_file",
    ),
    path(
        "manage/lots/<int:lot_id>/spaces/template/",
        space_creation.space_template_download,
        name="admin_space_template",
    ),
    # 车位管理
    ...
    path(
        "manage/spaces/<int:pk>/delete/",
        admin.parking_space_delete,
        name="admin_parking_space_delete",
    ),
    path(
        "manage/spaces/batch-create/",
        admin.parking_space_batch_create,
        name="admin_parking_space_batch_create",
    ),
    # 车辆管理
    ...
    path(
        "manage/records/<int:pk>/", admin.parking_record_detail, name="admin_parking_record_detail"
    ),
    path(
        "manage/records/<int:pk>/checkout/",
        admin.parking_record_checkout,
        name="admin_parking_record_checkout",
    ),
    ...
    path(
        ...
        name="api_send_verification_code",
    ),
    ...
    path(
        "manage/contact-messages/", contact.contact_message_list, name="admin_contact_message_list"
    ),
    path(
        "manage/contact-messages/<int:message_id>/reply/",
        contact.contact_message_reply,
        name="admin_contact_message_reply",
    ),
    # ==================== 排班管理 ====================
    path("manage/schedules/", schedule.schedule_list, name="admin_schedule_list"),
    path(
        "manage/schedules/template/",
        schedule.schedule_template_download,
        name="admin_schedule_template",
    ),
    path("manage/schedules/upload/", schedule.schedule_upload, name="admin_schedule_upload"),
    # ==================== 费率管理 ====================
    path(
        "manage/pricing/templates/",
        pricing.pricing_template_list,
        name="admin_pricing_template_list",
    ),
    path(
        "manage/pricing/templates/add/",
        pricing.pricing_template_edit,
        name="admin_pricing_template_add",
    ),
    path(
        "manage/pricing/templates/<int:template_id>/",
        pricing.pricing_template_edit,
        name="admin_pricing_template_edit",
    ),
    path(
        "manage/pricing/templates/<int:template_id>/delete/",
        pricing.pricing_template_delete,
        name="admin_pricing_template_delete",
    ),
    path(
        "manage/pricing/templates/<int:template_id>/copy/",
        pricing.pricing_template_copy,
        name="admin_pricing_template_copy",
    ),
    path(
        "manage/pricing/templates/create-from/",
        pricing.pricing_template_create_from,
        name="admin_pricing_template_create_from",
    ),
    path(
        "manage/pricing/templates/create-from/<int:template_id>/",
        pricing.pricing_template_create_from,
        name="admin_pricing_template_create_from_template",
    ),
    path(
        "manage/pricing/templates/template/",
        pricing.pricing_template_download,
        name="admin_pricing_template_download",
    ),
    path(
        "manage/pricing/templates/import/",
        pricing.pricing_template_import,
        name="admin_pricing_template_import",
    ),
    ...
    path(
        "manage/alert/wanted/<int:pk>/",
        alert.wanted_vehicle_detail,
        name="admin_wanted_vehicle_detail",
    ),
    path(
        "manage/alert/wanted/<int:pk>/edit/",
        alert.wanted_vehicle_edit,
        name="admin_wanted_vehicle_edit",
    ),
    path(
        "manage/alert/wanted/<int:pk>/delete/",
        alert.wanted_vehicle_delete,
        name="admin_wanted_vehicle_delete",
    ),
    path(
        "manage/alert/wanted/<int:pk>/cancel/",
        alert.wanted_vehicle_cancel,
        name="admin_wanted_vehicle_cancel",
    ),
    path("manage/alert/logs/", alert.alert_log_list, name="admin_alert_log_list"),
    path(
        "manage/alert/logs/<int:pk>/handle/", alert.alert_log_handle, name="admin_alert_log_handle"
    ),
]
